...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'dash-volt.com'
  config.app_name = 'Dash-volt'
  config.mailer.from = 'Dash-volt <no-reply@dash-volt.com>'
  ...
  #
  config.app_secret = 'wpoUxohEzfQQSpSCWpvVmDVgGK7mMQIer56Mw6y4Gd8Lt5aE9uyqkdiJIuY9GEVF3fQ'
